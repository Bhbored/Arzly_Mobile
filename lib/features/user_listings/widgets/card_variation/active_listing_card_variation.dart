...
class ActiveListingCardVariation extends StatelessWidget {
  const ActiveListingCardVariation({super.key, required this.listing});
  ...
  Widget build(BuildContext context) {
    return UserListingCardLayout(
      listing: listing,
      appearance: ListingStatus.active.cardAppearance(context),
    );
  }
}
