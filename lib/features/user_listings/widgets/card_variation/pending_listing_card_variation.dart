...
class PendingListingCardVariation extends StatelessWidget {
  const PendingListingCardVariation({super.key, required this.listing});
  ...
  Widget build(BuildContext context) {
    return UserListingCardLayout(
      listing: listing,
      appearance: ListingStatus.pending.cardAppearance(context),
    );
  }
}
