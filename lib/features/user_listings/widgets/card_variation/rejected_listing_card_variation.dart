...
class RejectedListingCardVariation extends StatelessWidget {
  const RejectedListingCardVariation({super.key, required this.listing});
  ...
  Widget build(BuildContext context) {
    return UserListingCardLayout(
      listing: listing,
      appearance: ListingStatus.rejected.cardAppearance(context),
    );
  }
}
