...
import 'package:arzly/features/new_listing/subscreens/phones_and_gadgets/mobile_accessories/mobile_accessories_step1_body.dart';
import 'package:arzly/features/new_listing/subscreens/phones_and_gadgets/mobile_accessories/mobile_accessories_step2_body.dart';
...
class MobileAccessoriesScreen extends ConsumerStatefulWidget {
  const MobileAccessoriesScreen({
    super.key,
  ...
  @override
  ConsumerState<MobileAccessoriesScreen> createState() =>
...
class _MobileAccessoriesScreenState
  ...
  Widget build(BuildContext context) {
    ...
    final premadeTitle = suggestedMobileAccessoriesTitle(ref);
