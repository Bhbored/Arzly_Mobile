...
import 'package:arzly/features/new_listing/subscreens/phones_and_gadgets/smart_watches/smart_watches_step1_body.dart';
import 'package:arzly/features/new_listing/subscreens/phones_and_gadgets/smart_watches/smart_watches_step2_body.dart';
...
class SmartWatchesScreen extends ConsumerStatefulWidget {
  const SmartWatchesScreen({
    super.key,
...
class _SmartWatchesScreenState extends ConsumerState<SmartWatchesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final premadeTitle = suggestedSmartWatchesTitle(ref);
