...
import 'package:arzly/features/new_listing/subscreens/phones_and_gadgets/mobile_numbers/mobile_numbers_step1_body.dart';
import 'package:arzly/features/new_listing/subscreens/phones_and_gadgets/mobile_numbers/mobile_numbers_step2_body.dart';
...
class MobileNumbersScreen extends ConsumerStatefulWidget {
  const MobileNumbersScreen({
    super.key,
  ...
  @override
  ConsumerState<MobileNumbersScreen> createState() =>
      _MobileNumbersScreenState();
}

class _MobileNumbersScreenState extends ConsumerState<MobileNumbersScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final premadeTitle = suggestedMobileNumbersTitle(ref);
