...
import 'package:arzly/features/new_listing/subscreens/phones_and_gadgets/mobile_phones/mobile_phones_step1_body.dart';
import 'package:arzly/features/new_listing/subscreens/phones_and_gadgets/mobile_phones/mobile_phones_step2_body.dart';
import 'package:arzly/features/new_listing/subscreens/phones_and_gadgets/phones_listing_from_temp.dart';
...
class MobilePhonesScreen extends ConsumerStatefulWidget {
  const MobilePhonesScreen({
    super.key,
  ...
  @override
  ConsumerState<MobilePhonesScreen> createState() =>
      _MobilePhonesScreenState();
}

class _MobilePhonesScreenState extends ConsumerState<MobilePhonesScreen> {
  ...
  void _tryAdvanceStep1() {
    ...
    final enumsOk = d.phoneBrand != null &&
  ...
  Future<void> _addListing() async {
    ...
    try {
      final uploaded = await ref
          ...
          .upload();
      final base = buildPhonesListingFromTempDrafts(
        ref,
  ...
  Widget build(BuildContext context) {
    ...
    final premadeTitle = suggestedMobilePhonesTitle(ref);
