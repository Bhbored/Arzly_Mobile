...
import 'package:arzly/features/new_listing/subscreens/vehicles/vehicle_spare_parts/vehicle_spare_parts_step1_body.dart';
...
class VehicleSparePartsScreen extends ConsumerStatefulWidget {
  const VehicleSparePartsScreen({
    super.key,
  ...
  @override
  ConsumerState<VehicleSparePartsScreen> createState() =>
          ...
          child: PageView(
            ...
            children: [
              ...
              NumberPlatesStep2Body(
                ...
                premadeTitle: suggestedVehicleSparePartsTitle(ref),
              ),
            ],
          ),
        ),
