...
import 'package:arzly/features/new_listing/subscreens/vehicles/trucks_buses/trucks_buses_step1_body.dart';
...
class TrucksBusesScreen extends ConsumerStatefulWidget {
  const TrucksBusesScreen({
    super.key,
  ...
  @override
  ConsumerState<TrucksBusesScreen> createState() => _TrucksBusesScreenState();
}

class _TrucksBusesScreenState extends ConsumerState<TrucksBusesScreen> {
  ...
  void _tryAdvanceStep1() {
    ...
    final pickersOk =
        veh.truckBrand != null && veh.year != null && veh.condition != null;
          ...
          child: PageView(
            ...
            children: [
              ...
              NumberPlatesStep2Body(
                ...
                premadeTitle: suggestedTrucksAndBusesTitle(ref),
              ),
            ],
          ),
        ),
