...
import 'package:arzly/features/new_listing/subscreens/vehicles/boats/boats_step1_body.dart';
...
class _BoatsScreenState extends ConsumerState<BoatsScreen> {
  ...
  void _tryAdvanceStep1() {
    ...
    final pickersOk =
        veh.boatType != null && veh.year != null && veh.condition != null;
          ...
          child: PageView(
            ...
            children: [
              ...
              NumberPlatesStep2Body(
                ...
                premadeTitle: suggestedBoatsTitle(ref),
              ),
            ],
          ),
        ),
