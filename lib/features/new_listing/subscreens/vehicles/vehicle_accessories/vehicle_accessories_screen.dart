...
import 'package:arzly/features/new_listing/subscreens/vehicles/vehicle_accessories/vehicle_accessories_step1_body.dart';
...
class VehicleAccessoriesScreen extends ConsumerStatefulWidget {
  const VehicleAccessoriesScreen({
    super.key,
  ...
  @override
  ConsumerState<VehicleAccessoriesScreen> createState() =>
      _VehicleAccessoriesScreenState();
}

class _VehicleAccessoriesScreenState extends ConsumerState<VehicleAccessoriesScreen> {
  ...
  void _tryAdvanceStep1() {
    ...
    final pickersOk = veh.accessoryType != null &&
          ...
          child: PageView(
            ...
            children: [
              ...
              NumberPlatesStep2Body(
                ...
                premadeTitle: suggestedVehicleAccessoriesTitle(ref),
              ),
            ],
          ),
        ),
