...
import 'package:arzly/features/new_listing/subscreens/real_estate/houses_for_rent/houses_for_rent_step1_body.dart';
import 'package:arzly/features/new_listing/subscreens/real_estate/houses_for_rent/houses_for_rent_step2_body.dart';
...
class HousesForRentScreen extends ConsumerStatefulWidget {
  const HousesForRentScreen({
    super.key,
  ...
  @override
  ConsumerState<HousesForRentScreen> createState() =>
      _HousesForRentScreenState();
}

class _HousesForRentScreenState extends ConsumerState<HousesForRentScreen> {
          ...
          child: PageView(
            ...
            children: [
              ...
              HousesForRentStep2Body(
                ...
                pageBg: pageBg,
                premadeTitle: suggestedHousesForRentTitle(ref),
              ),
            ],
          ),
        ),
