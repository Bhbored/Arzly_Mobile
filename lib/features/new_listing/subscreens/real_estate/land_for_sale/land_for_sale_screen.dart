...
import 'package:arzly/features/new_listing/subscreens/real_estate/land_for_sale/land_for_sale_step1_body.dart';
import 'package:arzly/features/new_listing/subscreens/real_estate/land_for_sale/land_for_sale_step2_body.dart';
...
class LandForSaleScreen extends ConsumerStatefulWidget {
  const LandForSaleScreen({
    super.key,
  ...
  @override
  ConsumerState<LandForSaleScreen> createState() => _LandForSaleScreenState();
}

class _LandForSaleScreenState extends ConsumerState<LandForSaleScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final landPremadeTitle = subName == RealEstateSubcategoryBody.landForRent
        ? suggestedLandForRentTitle(ref)
