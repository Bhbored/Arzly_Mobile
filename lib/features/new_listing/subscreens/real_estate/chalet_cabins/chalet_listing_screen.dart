...
import 'package:arzly/features/new_listing/subscreens/real_estate/chalet_cabins/chalet_listing_step1_body.dart';
import 'package:arzly/features/new_listing/subscreens/real_estate/chalet_cabins/chalet_listing_step2_body.dart';
...
class ChaletListingScreen extends ConsumerStatefulWidget {
  const ChaletListingScreen({
    super.key,
  ...
  @override
  ConsumerState<ChaletListingScreen> createState() =>
      _ChaletListingScreenState();
}

class _ChaletListingScreenState extends ConsumerState<ChaletListingScreen> {
  ...
  void _tryAdvanceStep1() {
    ...
    final enumsOk = re.ownership != null &&
        re.chaletType != null &&
        re.bedrooms != null &&
        re.floor != null &&
        re.propertyAge != null &&
  ...
  Widget build(BuildContext context) {
    ...
    final premadeTitle =
        subName == RealEstateSubcategoryBody.chaletsCabinsForRent
        ? suggestedChaletsCabinsForRentTitle(ref)
