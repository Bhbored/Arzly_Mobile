...
import 'package:arzly/features/new_listing/subscreens/real_estate/commercials/commercial_listing_step1_body.dart';
import 'package:arzly/features/new_listing/subscreens/real_estate/commercials/commercial_listing_step2_body.dart';
...
class CommercialListingScreen extends ConsumerStatefulWidget {
  const CommercialListingScreen({
    super.key,
  ...
  @override
  ConsumerState<CommercialListingScreen> createState() =>
      _CommercialListingScreenState();
}

class _CommercialListingScreenState
    extends ConsumerState<CommercialListingScreen> {
  ...
  void _tryAdvanceStep1() {
    ...
    final sizeOk =
        re.size != null &&
        re.size! > 0 &&
        re.size! <= HousesForSaleSizeM2InputFormatter.maxM2;
    final enumsOk =
        re.ownership != null &&
        re.floor != null &&
        re.commercialType != null &&
        re.condition != null &&
        re.propertyAge != null &&
  ...
  Widget build(BuildContext context) {
    ...
    final subName = widget.subcategory.name.trim();
    final commercialPremadeTitle =
        subName == RealEstateSubcategoryBody.commercialsForRent
        ? suggestedCommercialForRentTitle(ref)
          ...
          child: PageView(
            ...
            children: [
              ...
              CommercialListingStep2Body(
                ...
                pageBg: pageBg,
                premadeTitle: commercialPremadeTitle,
              ),
            ],
          ),
        ),
