...
import 'package:arzly/features/new_listing/subscreens/real_estate/rooms_for_rent/rooms_for_rent_step1_body.dart';
import 'package:arzly/features/new_listing/subscreens/real_estate/rooms_for_rent/rooms_for_rent_step2_body.dart';
...
class RoomsForRentScreen extends ConsumerStatefulWidget {
  const RoomsForRentScreen({
    super.key,
  ...
  @override
  ConsumerState<RoomsForRentScreen> createState() => _RoomsForRentScreenState();
}

class _RoomsForRentScreenState extends ConsumerState<RoomsForRentScreen> {
  ...
  void _tryAdvanceStep1() {
    ...
    final enumsOk = re.furnished != null &&
        re.floor != null &&
  ...
  Widget build(BuildContext context) {
    ...
    final premadeTitle = suggestedRoomsForRentTitle(ref);
