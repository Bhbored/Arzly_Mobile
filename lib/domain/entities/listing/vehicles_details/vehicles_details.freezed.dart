...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,motorcycleBrand,motorcycleModel,motorcycleFuelType,motorcycleCC,carBrand,carModel,version,carType,numberOfSeats,condition,horsepower,fuelConsumption,kilometers,year,numberOfOwners,fuelType,vehicleInterior,vehicleColor,numberOfDoors,transmissionType,const DeepCollectionEquality().hash(carFeatures),airConditioning,motorcycleType,accessoryType,numberOfDigits,truckBrand,boatType]);

@override
String toString() {
  return 'VehiclesDetails(motorcycleBrand: $motorcycleBrand, motorcycleModel: $motorcycleModel, motorcycleFuelType: $motorcycleFuelType, motorcycleCC: $motorcycleCC, carBrand: $carBrand, carModel: $carModel, version: $version, carType: $carType, numberOfSeats: $numberOfSeats, condition: $condition, horsepower: $horsepower, fuelConsumption: $fuelConsumption, kilometers: $kilometers, year: $year, numberOfOwners: $numberOfOwners, fuelType: $fuelType, vehicleInterior: $vehicleInterior, vehicleColor: $vehicleColor, numberOfDoors: $numberOfDoors, transmissionType: $transmissionType, carFeatures: $carFeatures, airConditioning: $airConditioning, motorcycleType: $motorcycleType, accessoryType: $accessoryType, numberOfDigits: $numberOfDigits, truckBrand: $truckBrand, boatType: $boatType)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'MotorcycleBrand')  String? motorcycleBrand, @JsonKey(name: 'MotorcycleModel')  String? motorcycleModel, @JsonKey(name: 'MotorcycleFuelType')  MotorcycleFuelType? motorcycleFuelType, @JsonKey(name: 'MotorcycleCC')  MotorcycleCC? motorcycleCC, @JsonKey(name: 'CarBrand')  String? carBrand, @JsonKey(name: 'CarModel')  String? carModel, @JsonKey(name: 'Version')  String? version, @JsonKey(name: 'CarType')  CarType? carType, @JsonKey(name: 'NumberOfSeats')  int? numberOfSeats, @JsonKey(name: 'Condition')  VehicleCondition? condition, @JsonKey(name: 'HorsePower')  int? horsepower, @JsonKey(name: 'FuelConsumptionLPer100Km')  double? fuelConsumption, @JsonKey(name: 'Kilometers')  int? kilometers, @JsonKey(name: 'Year')  int? year, @JsonKey(name: 'NumberOfOwners')  int? numberOfOwners, @JsonKey(name: 'FuelType')  FuelType? fuelType, @JsonKey(name: 'VehicleInterior')  VehicleInterior? vehicleInterior, @JsonKey(name: 'VehicleColor')  VehicleColor? vehicleColor, @JsonKey(name: 'NumberOfDoors')  int? numberOfDoors, @JsonKey(name: 'TransmissionType')  TransmissionType? transmissionType, @JsonKey(name: 'CarFeatures')  List<CarFeature>? carFeatures, @JsonKey(name: 'AirConditioning')  AirConditioning? airConditioning, @JsonKey(name: 'MotorcycleType')  MotorcycleType? motorcycleType, @JsonKey(name: 'AccessoryType')  AccessoryType? accessoryType, @JsonKey(name: 'NumberOfDigits')  PlateDigits? numberOfDigits, @JsonKey(name: 'TruckBrand')  TruckBrand? truckBrand, @JsonKey(name: 'BoatType')  BoatType? boatType)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _VehiclesDetails() when $default != null:
return $default(_that.motorcycleBrand,_that.motorcycleModel,_that.motorcycleFuelType,_that.motorcycleCC,_that.carBrand,_that.carModel,_that.version,_that.carType,_that.numberOfSeats,_that.condition,_that.horsepower,_that.fuelConsumption,_that.kilometers,_that.year,_that.numberOfOwners,_that.fuelType,_that.vehicleInterior,_that.vehicleColor,_that.numberOfDoors,_that.transmissionType,_that.carFeatures,_that.airConditioning,_that.motorcycleType,_that.accessoryType,_that.numberOfDigits,_that.truckBrand,_that.boatType);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'MotorcycleBrand')  String? motorcycleBrand, @JsonKey(name: 'MotorcycleModel')  String? motorcycleModel, @JsonKey(name: 'MotorcycleFuelType')  MotorcycleFuelType? motorcycleFuelType, @JsonKey(name: 'MotorcycleCC')  MotorcycleCC? motorcycleCC, @JsonKey(name: 'CarBrand')  String? carBrand, @JsonKey(name: 'CarModel')  String? carModel, @JsonKey(name: 'Version')  String? version, @JsonKey(name: 'CarType')  CarType? carType, @JsonKey(name: 'NumberOfSeats')  int? numberOfSeats, @JsonKey(name: 'Condition')  VehicleCondition? condition, @JsonKey(name: 'HorsePower')  int? horsepower, @JsonKey(name: 'FuelConsumptionLPer100Km')  double? fuelConsumption, @JsonKey(name: 'Kilometers')  int? kilometers, @JsonKey(name: 'Year')  int? year, @JsonKey(name: 'NumberOfOwners')  int? numberOfOwners, @JsonKey(name: 'FuelType')  FuelType? fuelType, @JsonKey(name: 'VehicleInterior')  VehicleInterior? vehicleInterior, @JsonKey(name: 'VehicleColor')  VehicleColor? vehicleColor, @JsonKey(name: 'NumberOfDoors')  int? numberOfDoors, @JsonKey(name: 'TransmissionType')  TransmissionType? transmissionType, @JsonKey(name: 'CarFeatures')  List<CarFeature>? carFeatures, @JsonKey(name: 'AirConditioning')  AirConditioning? airConditioning, @JsonKey(name: 'MotorcycleType')  MotorcycleType? motorcycleType, @JsonKey(name: 'AccessoryType')  AccessoryType? accessoryType, @JsonKey(name: 'NumberOfDigits')  PlateDigits? numberOfDigits, @JsonKey(name: 'TruckBrand')  TruckBrand? truckBrand, @JsonKey(name: 'BoatType')  BoatType? boatType)  $default,) {final _that = this;
switch (_that) {
case _VehiclesDetails():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'MotorcycleBrand')  String? motorcycleBrand, @JsonKey(name: 'MotorcycleModel')  String? motorcycleModel, @JsonKey(name: 'MotorcycleFuelType')  MotorcycleFuelType? motorcycleFuelType, @JsonKey(name: 'MotorcycleCC')  MotorcycleCC? motorcycleCC, @JsonKey(name: 'CarBrand')  String? carBrand, @JsonKey(name: 'CarModel')  String? carModel, @JsonKey(name: 'Version')  String? version, @JsonKey(name: 'CarType')  CarType? carType, @JsonKey(name: 'NumberOfSeats')  int? numberOfSeats, @JsonKey(name: 'Condition')  VehicleCondition? condition, @JsonKey(name: 'HorsePower')  int? horsepower, @JsonKey(name: 'FuelConsumptionLPer100Km')  double? fuelConsumption, @JsonKey(name: 'Kilometers')  int? kilometers, @JsonKey(name: 'Year')  int? year, @JsonKey(name: 'NumberOfOwners')  int? numberOfOwners, @JsonKey(name: 'FuelType')  FuelType? fuelType, @JsonKey(name: 'VehicleInterior')  VehicleInterior? vehicleInterior, @JsonKey(name: 'VehicleColor')  VehicleColor? vehicleColor, @JsonKey(name: 'NumberOfDoors')  int? numberOfDoors, @JsonKey(name: 'TransmissionType')  TransmissionType? transmissionType, @JsonKey(name: 'CarFeatures')  List<CarFeature>? carFeatures, @JsonKey(name: 'AirConditioning')  AirConditioning? airConditioning, @JsonKey(name: 'MotorcycleType')  MotorcycleType? motorcycleType, @JsonKey(name: 'AccessoryType')  AccessoryType? accessoryType, @JsonKey(name: 'NumberOfDigits')  PlateDigits? numberOfDigits, @JsonKey(name: 'TruckBrand')  TruckBrand? truckBrand, @JsonKey(name: 'BoatType')  BoatType? boatType)?  $default,) {final _that = this;
switch (_that) {
case _VehiclesDetails() when $default != null:
return $default(_that.motorcycleBrand,_that.motorcycleModel,_that.motorcycleFuelType,_that.motorcycleCC,_that.carBrand,_that.carModel,_that.version,_that.carType,_that.numberOfSeats,_that.condition,_that.horsepower,_that.fuelConsumption,_that.kilometers,_that.year,_that.numberOfOwners,_that.fuelType,_that.vehicleInterior,_that.vehicleColor,_that.numberOfDoors,_that.transmissionType,_that.carFeatures,_that.airConditioning,_that.motorcycleType,_that.accessoryType,_that.numberOfDigits,_that.truckBrand,_that.boatType);case _:
  return null;
...
/// Create a copy of VehiclesDetails
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? motorcycleBrand = freezed,Object? motorcycleModel = freezed,Object? motorcycleFuelType = freezed,Object? motorcycleCC = freezed,Object? carBrand = freezed,Object? carModel = freezed,Object? version = freezed,Object? carType = freezed,Object? numberOfSeats = freezed,Object? condition = freezed,Object? horsepower = freezed,Object? fuelConsumption = freezed,Object? kilometers = freezed,Object? year = freezed,Object? numberOfOwners = freezed,Object? fuelType = freezed,Object? vehicleInterior = freezed,Object? vehicleColor = freezed,Object? numberOfDoors = freezed,Object? transmissionType = freezed,Object? carFeatures = freezed,Object? airConditioning = freezed,Object? motorcycleType = freezed,Object? accessoryType = freezed,Object? numberOfDigits = freezed,Object? truckBrand = freezed,Object? boatType = freezed,}) {
