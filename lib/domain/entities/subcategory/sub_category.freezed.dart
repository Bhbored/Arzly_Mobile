...
mixin _$SubCategory {
 ...
 String get id; String get categoryId; String get name; String? get description; int get itemsCount;
...
@override
String toString() {
  return 'SubCategory(id: $id, categoryId: $categoryId, name: $name, description: $description, itemsCount: $itemsCount)';
}
...
@useResult
$Res call({
 String id, String categoryId, String name, String? description, int itemsCount
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String categoryId,  String name,  String? description,  int itemsCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SubCategory() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String categoryId,  String name,  String? description,  int itemsCount)  $default,) {final _that = this;
switch (_that) {
case _SubCategory():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String categoryId,  String name,  String? description,  int itemsCount)?  $default,) {final _that = this;
switch (_that) {
case _SubCategory() when $default != null:
return $default(_that.id,_that.categoryId,_that.name,_that.description,_that.itemsCount);case _:
  return null;
...
class _SubCategory implements SubCategory {
  const _SubCategory({required this.id, required this.categoryId, required this.name, this.description, required this.itemsCount});
