...
mixin _$UserPreferences {
 ...
 ThemeMode get theme; LanguageCode get language; bool get pushNotifications; bool get emailNotifications;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,theme,language,pushNotifications,emailNotifications);

@override
String toString() {
  return 'UserPreferences(theme: $theme, language: $language, pushNotifications: $pushNotifications, emailNotifications: $emailNotifications)';
}
...
@useResult
$Res call({
 ThemeMode theme, LanguageCode language, bool pushNotifications, bool emailNotifications
});
...
/// Create a copy of UserPreferences
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? theme = null,Object? language = null,Object? pushNotifications = null,Object? emailNotifications = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ThemeMode theme,  LanguageCode language,  bool pushNotifications,  bool emailNotifications)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserPreferences() when $default != null:
return $default(_that.theme,_that.language,_that.pushNotifications,_that.emailNotifications);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ThemeMode theme,  LanguageCode language,  bool pushNotifications,  bool emailNotifications)  $default,) {final _that = this;
switch (_that) {
case _UserPreferences():
return $default(_that.theme,_that.language,_that.pushNotifications,_that.emailNotifications);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ThemeMode theme,  LanguageCode language,  bool pushNotifications,  bool emailNotifications)?  $default,) {final _that = this;
switch (_that) {
case _UserPreferences() when $default != null:
return $default(_that.theme,_that.language,_that.pushNotifications,_that.emailNotifications);case _:
  return null;
...
class _UserPreferences implements UserPreferences {
  const _UserPreferences({required this.theme, required this.language, required this.pushNotifications, required this.emailNotifications});
...
/// Create a copy of UserPreferences
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? theme = null,Object? language = null,Object? pushNotifications = null,Object? emailNotifications = null,}) {
