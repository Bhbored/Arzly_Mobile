...
@JsonKey(name: 'Id') String get id;@JsonKey(name: 'Label') LocationLabel get label;@JsonKey(name: 'Address') String get address;@JsonKey(name: 'Notes') String? get notes;@JsonKey(name: 'Lat') double get lat;@JsonKey(name: 'Lon') double get lon;@JsonKey(name: 'IsDefault') bool get isDefault;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,label,address,notes,lat,lon,isDefault);

@override
String toString() {
  return 'PickupLocationUpdateRequest(id: $id, label: $label, address: $address, notes: $notes, lat: $lat, lon: $lon, isDefault: $isDefault)';
}
...
@useResult
$Res call({
@JsonKey(name: 'Id') String id,@JsonKey(name: 'Label') LocationLabel label,@JsonKey(name: 'Address') String address,@JsonKey(name: 'Notes') String? notes,@JsonKey(name: 'Lat') double lat,@JsonKey(name: 'Lon') double lon,@JsonKey(name: 'IsDefault') bool isDefault
});
...
/// Create a copy of PickupLocationUpdateRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? label = null,Object? address = null,Object? notes = freezed,Object? lat = null,Object? lon = null,Object? isDefault = null,}) {
...
switch (_that) {
case _PickupLocationUpdateRequest() when $default != null:
return $default(_that.id,_that.label,_that.address,_that.notes,_that.lat,_that.lon,_that.isDefault);case _:
  return orElse();
...
switch (_that) {
case _PickupLocationUpdateRequest():
return $default(_that.id,_that.label,_that.address,_that.notes,_that.lat,_that.lon,_that.isDefault);}
}
...
class _PickupLocationUpdateRequest implements PickupLocationUpdateRequest {
  const _PickupLocationUpdateRequest({@JsonKey(name: 'Id') required this.id, @JsonKey(name: 'Label') required this.label, @JsonKey(name: 'Address') required this.address, @JsonKey(name: 'Notes') this.notes, @JsonKey(name: 'Lat') required this.lat, @JsonKey(name: 'Lon') required this.lon, @JsonKey(name: 'IsDefault') required this.isDefault});
...
/// Create a copy of PickupLocationUpdateRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? label = null,Object? address = null,Object? notes = freezed,Object? lat = null,Object? lon = null,Object? isDefault = null,}) {
