...
switch (_that) {
case _ListingResponse():
return $default(_that.id,_that.title,_that.description,_that.price,_that.isPriceNegotiable,_that.status,_that.primaryImageUrl,_that.imagesUrl,_that.createdAt,_that.updatedAt,_that.ownerId,_that.categoryId,_that.subcategoryId,_that.pickupLocationId,_that.listingDetails,_that.name,_that.phoneNumber,_that.contactMethod,_that.isPromoted,_that.promotionType,_that.promotionStartDate,_that.promotionEndDate);}
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,description,price,isPriceNegotiable,status,primaryImageUrl,const DeepCollectionEquality().hash(_imagesUrl),createdAt,updatedAt,ownerId,categoryId,subcategoryId,pickupLocationId,const DeepCollectionEquality().hash(listingDetails),name,phoneNumber,contactMethod,isPromoted,promotionType,promotionStartDate,promotionEndDate]);
